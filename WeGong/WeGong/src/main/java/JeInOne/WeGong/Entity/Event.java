...
public class Event {
    ...
    @ManyToMany
    @JoinTable(name = "event_musicians",
            joinColumns = @JoinColumn(name = "event_id"),
            inverseJoinColumns = @JoinColumn(name = "musician_id"))
    private List<Musician> musicians = new ArrayList<>();

    @ElementCollection
    @CollectionTable(name = "event_organizers", joinColumns = @JoinColumn(name = "event_id"))
    ...
    public Event(String name, LocalDate startDate, LocalDate endDate,
                 ...
                 Integer ticketPriceOnsite, Venue venue, List<Musician> musicians, List<String> organizers) {
        this.name = name;
